...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="/view/stylesheets/style_CGU.css">
  </head>
  <body>
  <?php require './view/header_accueil.php'?>

  <center><h1>Conditions générales d'utilisation</h1></center>
  <section>
    <div class="article">
        <h3>Article 1 : Nature des données collectées</h3>
        <p><b>Dans le cadre de l'utilisation du site DrivingAces de la société Navajo, l'Éditeur est susceptible de collecter les catégories de données suivantes concernant ses Utilisateurs :</b></p>
        <p>Données d'état-civil, d'identité, d'identification...</p>


      </div>
      <div class="article">
        <h3>Article 2 : Communication des données personnelles à des tiers</h3>
      ...
      <div class="article">
        <h3>Article 3 : Collecte des données d'identité</h3><p>
      ...
      <div class="article">
        <h3>Article 4 : Collecte des données d'identification</h3><p>
      ...
      <div class="article">
        <h3>Article 5 : Collecte des données du terminal</h3><p>
      ...
      <div class="article">
        ...
        <p><b>Opt-in pour le dépôt de cookies</b>
        <br>
      ...
      <div class="article">
        <h3>Article 7 : Conservation des données techniques</h3>
        <p><b>Durée de conservation des données techniques</b>
        <br>
      ...
      <div class="article">
        <h3>Article 8 : Délai de conservation des données personnelles et d'anonymisation</h3>
        <p><b>Conservation des données pendant la durée de la relation contractuelle</b>
        <br>
        ...
        <p><b>Conservation des données anonymisées au delà de la relation contractuelle / après la suppression du compte</b>
        <br>
        ...
        <p><b>Suppression des données après suppression du compte</b>
        <br>
        ...
        <p><b>Suppression des données après 3 ans d'inactivité</b>
        <br>
      ...
      <div class="article">
        <h3>Article 9 : Suppression du compte</h3>
        <p><b>Suppression du compte à la demande</b>
        <br>
      ...
      <div class="article">
        <h3>Article 10 : Indications en cas de faille de sécurité décelée par l'Éditeur</h3>
        <p>
        <b>
      ...
      <div class="article">
        <h3>Article 11 : Transfert des données personnelles à l'étranger</h3><p>
        <b>
      ...
      <div class="article">
        <h3> Article 12 : Modification des CGU et de la politique de confidentialité</h3>
        <p><b>
      ...
      <div class="article">
        <h3>Article 13 : Droit applicable et modalités de recours</h3><p>
        <b>
